...
export const reducer=(state=initState,{type,payload})=>{
    ...
    switch(type){
        ...
        case GET_Video_SUCCESS:return {...state,isLoading:false,videos:payload};
        case ADD_PRODUCT_SUCCESS:return {...state,isLoading:false,data:[...state.data,payload]};
        case ADD_User_SUCCESS:return {...state,isLoading:false,data:[...state.users,payload]};
        case ADD_Video_SUCCESS:return {...state,isLoading:false,data:[...state.videos,payload]};
        case PATCH_PRODUCT_SUCCESS:return {...state,isLoading:false,data:[...state.data,payload]};
        case PATCH_User_SUCCESS:return {...state,isLoading:false,data:[...state.users,payload]};
        case PATCH_Video_SUCCESS:return {...state,isLoading:false,data:[...state.videos,payload]};
        case DELETE_PRODUCT_SUCCESS:return {...state,isLoading:false,data:payload};
        case DELETE_User_SUCCESS:return {...state,isLoading:false,data:payload};
        case DELETE_Video_SUCCESS:return {...state,isLoading:false,data:payload};
