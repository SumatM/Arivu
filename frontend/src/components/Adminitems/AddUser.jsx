  ...
  return (
   ...
   <FormControl>
        ...
        <FormControl mt={4}>
          ...
          <Input type="number" placeholder="Enter Age" name="age" value={detail.age} onChange={handleChange} />
        </FormControl>
        <FormControl mt={4}>
          <FormLabel>Job</FormLabel>
          <Input type="text" placeholder="Enter Job" name="job" value={detail.job} onChange={handleChange} />
        </FormControl>
        <FormControl mt={4}>
          <FormLabel>Image</FormLabel>
          <Input type="text" placeholder="Enter Image URL" name="image" value={detail.image} onChange={handleChange} />
        </FormControl>
