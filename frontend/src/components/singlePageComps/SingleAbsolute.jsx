...
></iframe>
      ...
      <div>
        <h3 className="font-serif font-bold max-w-[250px] py-1 ">Subscribe to Udemy's top courses</h3>
      ...
      <div className="flex text-red-600 items-baseline space-x-1 my-2">
       ...
       <button className=" border-2 w-full py-[7px] text-sm font-bold">
        Buy this course
       </button>
       ...
       <div className="underline flex text-[11px] font-bold justify-around underline-offset-2 pb-7">
        <div><a href="http://">share</a></div>
        <div><a href="">Gift this course</a></div>
        <div><a href="">ApplyCoupan</a></div>
       </div>
        </div>
    </div>
  );
